...
<head>
    ...
    <title>List Ujian - Maxxima</title>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                  action="{{ route('ujian.destroy', $data->id) }}" method="POST">

                                @csrf
                                @method('DELETE')
                                <a href="{{ route('ujian.show', $data->id) }}" id="{{ $data->id }}-edit-btn"
                                ...
                                <a href="{{ route('ujian.edit', $data->id) }}" id="{{ $data->id }}-edit-btn"
