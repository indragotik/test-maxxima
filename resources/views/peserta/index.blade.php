...
<div class="container mx-auto mt-10 mb-10 px-10">
    <table>
        <tr>
            ...
            <th class="px-2">
                <a href="{{ route('peserta.index') }}" class="text-blue-500 hover:text-blue-200">Mata Pelajaran</a>
            </th>
            <th class="px-2">
        ...
        <div class="col-span-4">
            <div class="flex justify-end">
                <a href="{{ route('peserta.create') }}"
                   ...
                   id="add-peserta-btn">Add Peserta</a>
            </div>
        </div>
    </div>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                  action="{{ route('peserta.destroy', $data) }}" method="POST">

                                @csrf
                                @method('DELETE')
                                <a href="{{ route('peserta.show', $data) }}" id="{{ $data->id }}-edit-btn"
                                ...
                                <a href="{{ route('peserta.edit', $data) }}" id="{{ $data->id }}-edit-btn"
