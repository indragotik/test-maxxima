        ...
        <div class="col-span-4">
            <div class="flex justify-end">
                <a href="{{ route('mata-pelajaran.create') }}"
                   ...
                   id="add-mata-pelajaran-btn">Add Mata Pelajaran</a>
            </div>
        </div>
    </div>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                  action="{{ route('mata-pelajaran.destroy', $data) }}" method="POST">

                                @csrf
                                @method('DELETE')
                                <a href="{{ route('mata-pelajaran.show', $data) }}" id="{{ $data->id }}-edit-btn"
                                ...
                                <a href="{{ route('mata-pelajaran.edit', $data) }}" id="{{ $data->id }}-edit-btn"
